...
# TODO: не забыть поменять граничные условия при изменении геометрии
...
walls    = 'near(x[1], 0) || near(x[1], 0.41) || near(x[2], 0.41) || near(x[2], 0)'
cylinder = 'on_boundary && x[0]>0.1 && x[0]<0.3 && x[1]>0.1 && x[1]<0.3 && x[2]>0.1 && x[2]<0.3'
...
file_u = File('navier_stokes_cylinder_3d_v2/velocity.pvd')
file_p = File('navier_stokes_cylinder_3d_v2/pressure.pvd')
